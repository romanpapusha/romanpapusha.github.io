...
<head>
  <!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-ZT57Y4Z50R"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-ZT57Y4Z50R');
</script>
<!-- Google tag (gtag.js) -->
  <meta charset="UTF-8">
...
<body>
  ...
  <main>
    ...
    <img src="https://res.cloudinary.com/ddjuftfy2/image/upload/f_webp,c_fill,q_auto/memphis/large/2913ab82d46675e6a27d9c7fbe5457e7.jpg" width="500">
